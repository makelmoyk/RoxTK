            ...
            modelBuilder.Entity("RoxTK.Models.Timekeep", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            TimekeepId = 1,
                            DateCreated = new DateTime(2020, 4, 23, 19, 2, 49, 467, DateTimeKind.Local).AddTicks(9107),
                            EmployeeId = 1,
            ...
            modelBuilder.Entity("RoxTK.Models.User", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            UserId = 1,
                            DateCreated = new DateTime(2020, 4, 23, 19, 2, 49, 466, DateTimeKind.Local).AddTicks(4918),
                            Password = "Password1",
                            Username = "Admin"
                        });
                });
