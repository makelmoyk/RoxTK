...
namespace RoxTK.API.Migrations
{
    ...
    [Migration("20200424082708_AddedUserRoles")]
            ...
            modelBuilder.Entity("RoxTK.Models.Timekeep", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            TimekeepId = 1,
                            DateCreated = new DateTime(2020, 4, 24, 16, 27, 8, 209, DateTimeKind.Local).AddTicks(7366),
                            EmployeeId = 1,
            ...
            modelBuilder.Entity("RoxTK.Models.User", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            UserId = 1,
                            DateCreated = new DateTime(2020, 4, 24, 16, 27, 8, 208, DateTimeKind.Local).AddTicks(3276),
                            Password = "Password1",
                            Role = 0,
                            Username = "Admin"
                        });
